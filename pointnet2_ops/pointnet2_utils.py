...
class QueryAndGroup(nn.Module):
    ...
    def __init__(self, radius, nsample, use_xyz=True, use_global_xyz=False):
        # type: (QueryAndGroup, float, int, bool) -> None
        super(QueryAndGroup, self).__init__()
        self.radius, self.nsample, self.use_xyz, self.use_global_xyz = radius, nsample, use_xyz, use_global_xyz
